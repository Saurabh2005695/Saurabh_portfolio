...
A state-of-the-art, interactive 3D portfolio website built to showcase projects, skills, and software development experience. Features custom **Three.js 3D space animations**, **3D card tilt physics**, **glassmorphism styling**, **dynamic dark/light themes**, and an immersive intro experience.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/Saurabh2005695/Saurabh_portfolio.git
   ```
...
3. **Launch the site**:
   ...
   - Alternatively, use VS Code **Live Server** extension or run a simple local HTTP server:
     ```bash
     npx serve .
     ```
...
```text
Saurabh_portfolio/
├── assets/                  # Images, profile photos, and media assets
│   └── 1000042575.jpg
├── index.html               # Main HTML entry point with semantic markup & 3D canvas
├── style.css                # Custom CSS design system, glassmorphism, animations & themes
├── script.js                # Core JS: Three.js 3D sky scene, typing effect & dynamic UI
...
<p align="center">
  <b>© 2025 Saurabh Shriwastava. All Rights Reserved.</b>
</p>
